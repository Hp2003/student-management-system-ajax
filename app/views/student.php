...
<html lang="en">
  ...
  <body>
  <a  href="../views/addStudentForm.php" class="btn btn-primary">Add Student</a>
    ...
    <div class="container mt-5">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a type="button" href="<?php echo "/hiren/mvc2/app/views/editStudentForm.php?id=" . $student['id']  ?>" class="btn btn-primary">Edit</a></td>
          <td>
