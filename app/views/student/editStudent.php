    ...
    <div class="container mt-5">
        ...
        <form action="../../controllers/StudentController.php" method="POST">
            ...
            <div class="mb-3">
                ...
                Female : <input type="radio" name="gender" value="female" class="mx-2" <?php echo ($inputs['gender'] ?? $student->gender) === 'female' ? 'selected' : '' ?> id="">
                Other : <input type="radio" name="gender" value="other" class="mx-2" <?php echo ($inputs['gender'] ?? $student->gender) === 'other' ? 'selected' : '' ?> id="">
            </div>
